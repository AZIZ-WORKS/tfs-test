...
const isChildOf_1 = require("../util/isChildOf");
...
class RegistrationCoordinator {
    constructor(io, bundleManager, replicator) {
        ...
        io.on("connection", (socket) => {
            socket.on("graphic:registerSocket", (regRequest, cb) => {
                ...
                if (existingSocketRegistration) {
                    ...
                    this._addRegistration(Object.assign(Object.assign({}, regRequest), { ipv4: socket.request.socket.remoteAddress, socketId: socket.id, singleInstance: Boolean(graphicManifest.singleInstance), potentiallyOutOfDate: calcBundleGitMismatch(bundle, regRequest) ||
                            calcBundleVersionMismatch(bundle, regRequest), open: true }));
        ...
        app.get("/instance/*", (req, res, next) => {
            ...
            if (resName.endsWith(".html") && (0, isChildOf_1.isChildOf)(BUILD_PATH, fileLocation)) {
