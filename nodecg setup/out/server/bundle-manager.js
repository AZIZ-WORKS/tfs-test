...
class BundleManager extends typed_emitter_1.TypedEmitter {
    ...
    constructor(bundlesPaths, cfgPath, nodecgVersion, nodecgConfig) {
        ...
        this._debouncedManifestDeletionCheck = (0, lodash_1.debounce)((bundleName, manifestPath) => {
        ...
        this._debouncedGitChangeHandler = (0, lodash_1.debounce)((bundleName) => {
        ...
        bundlesPaths.forEach((bundlesPath) => {
            ...
            if (!node_fs_1.default.existsSync(bundlesPath)) {
                node_fs_1.default.mkdirSync(bundlesPath, { recursive: true });
            }
            ...
            bundleFolders.forEach((bundleFolderName) => {
                ...
                if (((_c = nodecgConfig === null || nodecgConfig === void 0 ? void 0 : nodecgConfig["bundles"]) === null || _c === void 0 ? void 0 : _c.enabled) &&
                    !(nodecgConfig === null || nodecgConfig === void 0 ? void 0 : nodecgConfig["bundles"].enabled.includes(bundleFolderName))) {
                ...
                const bundle = (0, bundle_parser_1.parseBundle)(bundlePath, loadBundleCfg(cfgPath, bundleFolderName));
...
function extractBundleName(bundlesPath, filePath) {
    return filePath.replace(bundlesPath, "").split(node_path_1.default.sep)[1];
}
/**
