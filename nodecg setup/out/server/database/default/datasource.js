...
const testing = ((_a = process.env.NODECG_TEST) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === "true";
exports.dataSource = new typeorm_1.DataSource({
    ...
    database: testing
        ? ":memory:"
        : node_path_1.default.join(rootPath_1.nodecgRootPath, "db/nodecg.sqlite3"),
    logging: false,
    entities: [entity_1.ApiKey, entity_1.Identity, entity_1.Permission, entity_1.Replicant, entity_1.Role, entity_1.User],
    migrations: [
        node_path_1.default.join(rootPath_1.nodecgRootPath, "out/server/database/default/migration/*.js"),
    ],
    migrationsRun: true,
    synchronize: false,
});
