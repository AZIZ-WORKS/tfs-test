...
const sendFile_1 = require("./util/sendFile");
...
const createAssetsMiddleware = (bundles, replicator) => {
    ...
    watcher.on("change", (filepath) => {
        (0, debounce_name_1.debounceName)(filepath, () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const sum = yield hasha_1.default.fromFile(filepath, { algorithm: "sha1" });
    ...
    (req, res, next) => {
        ...
        (0, sendFile_1.sendFile)(parentDir, fullPath, res, next);
    });
    // Upload new files
