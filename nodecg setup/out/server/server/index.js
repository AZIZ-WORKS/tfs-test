...
const database_adapter_1 = require("../database/default/database-adapter");
...
class NodeCGServer extends typed_emitter_1.TypedEmitter {
    constructor() {
        super();
        this.log = (0, logger_1.createLogger)("server");
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            log.info("Starting NodeCG %s (Running on Node.js %s)", pjson_1.pjson.version, process.version);
            if (config_1.sentryEnabled) {
            ...
            const bundlesPaths = [path.join(nodecg_root_1.NODECG_ROOT, "bundles")].concat((_b = (_a = config_1.config.bundles) === null || _a === void 0 ? void 0 : _a.paths) !== null && _b !== void 0 ? _b : []);
            const cfgPath = path.join(nodecg_root_1.NODECG_ROOT, "cfg");
            const bundleManager = new bundle_manager_1.BundleManager(bundlesPaths, cfgPath, pjson_1.pjson.version, config_1.config);
            let databaseAdapter = database_adapter_1.defaultAdapter;
            ...
            if ((_c = config_1.config.login) === null || _c === void 0 ? void 0 : _c.enabled) {
            ...
            const persistedReplicantEntities = yield databaseAdapter.getAllReplicants();
